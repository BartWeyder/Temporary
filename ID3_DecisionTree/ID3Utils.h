...
namespace ID3Utils
{
   ...
   /// @brief Calculates gains per each attribute.
   /// @param i_examples in, Data set.
   /// @param i_attributes in, List of attributes headers (indices in our case).
   /// @return Map of attribute and corresponding gain value. 
